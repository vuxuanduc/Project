...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img src="./image/44.jpg" class="d-block w-100" alt="...">
                    </div>
                </div>
            </div>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-3 col-md-3 col-md-4 col-sm-6 col-12 my-2">
                    <img class="logo-footer" src="./image/1-removebg-preview.png" alt="">
                    ...
                    <img width="150px" height="auto" src="./image/logoBCT.png" alt="">
                </div>
                <div class="col-lg-3 col-md-3 col-md-4 col-sm-6 col-12 my-2">
                    <h6>DU LỊCH 24</h6>
                    <ul class="nav-footer">
