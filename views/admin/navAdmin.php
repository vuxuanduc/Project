...
<h6 class="text-center my-2">QUẢN TRỊ</h6>
    <ul>
        <li><a href="?action=managerHotels">Khách sạn</a></li>
        <li><a href="?action=managerTypeRoom">Loại phòng</a></li>
        <li><a href="?action=managerRoom">Phòng</a></li>
...
<div class="table-responsive my-2 nav-admin-table">
    <table class="table">
        <thead class="" style="background-color: #86B817;">
            <tr>
                <th><a class="text-white" href="?action=managerHotels">Khách sạn</a></th>
                <th><a class="text-white" href="?action=managerTypeRoom">Loại phòng</a></th>
                <th><a class="text-white" href="?action=managerRoom">Phòng</a></th>
