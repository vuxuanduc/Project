    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            new Morris.Bar({
                element: 'chart',
                data: [
                    <?php foreach($StatisticsRevenue as $Revenues => $Revenue) : ?>
                        { TotalAmount: '<?php echo $Revenue -> NameHotel ?>', value: <?php echo $Revenue -> total_revenue ?> },
                    <?php endforeach ; ?>
                ],
                xkey: 'TotalAmount',  
                ykeys: ['value'],
        ...
        <a href="?action=chartBookings" class="btn" style="border:1px solid black; margin-top:15px;">Thống kê lượt đặt phòng</a>
